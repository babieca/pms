...
function randomWords(n){
	var words = [ "Apple", "beer", "cake", "potato", "Banana", "The", "Orange", "House", "Boat", "Lake", "Car", "And" ];
	var text = "";
	for(i = 0; i < n; i++) {
...
function doc_node(pagenum, data){
	...
	var node =  
		'<div class="page" id="page' + pagenum + '">' +
			...
			'<div class="row">' +
			    '<div class="comments col-md-8 offset-md-2" style="margin-bottom:5px">' +
			        '<div class="media g-mb-30 media-comment" style="padding: 30px; margin-bottom:3px">' +
			    ...
			    '<div class="comments col-md-8 offset-md-2" style="margin-bottom:5px">' +
			        '<div class="media g-mb-30 media-comment" style="padding: 30px;">' +
